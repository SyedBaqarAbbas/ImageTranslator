    ...
    <header className="sticky top-0 z-40 border-b border-ink-border bg-background/86 backdrop-blur-xl">
      <div className="flex h-16 items-center justify-between gap-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-3">
          ...
          <button className="hidden items-center gap-2 rounded-instrument border border-ink-border px-3 py-2 text-sm font-semibold text-text-main transition hover:bg-surface-high sm:flex">
