      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
              ...
              {(["balanced", "high"] as const).map((mode) => (
                <button
                  ...
                  className={`flex items-center justify-between rounded-instrument border px-4 py-3 text-left text-sm font-bold capitalize transition ${
                    qualityMode === mode ? "border-secondary bg-secondary/10 text-white" : "border-ink-border bg-background text-text-muted hover:border-accent/50 hover:text-white"
                  }`}
                >
                  {mode} quality
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button onClick={handleSave} className="inline-flex items-center justify-center gap-2 rounded-instrument bg-primary px-4 py-3 text-sm font-bold text-white shadow-action transition hover:bg-action-hover">
