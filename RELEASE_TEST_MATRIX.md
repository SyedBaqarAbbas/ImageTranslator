...
| Tesseract + OPUS-MT Korean | Opt-in | Local-only annotated manhwa fixtures compare legacy full-page detection, bounded Korean detection, manual crops, and translation usability |
