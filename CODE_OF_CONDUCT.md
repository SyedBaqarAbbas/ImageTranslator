...
ImageTranslator follows the Contributor Covenant Code of Conduct, adapted for
this project's prototype open-source workflow.
...
officially representing the project in public spaces. Examples of representing
the project include using an official project email address, posting through an
...
maintainers. If no private maintainer contact is available, open a GitHub issue
requesting a private contact path and do not include sensitive personal details
in the public issue.

Maintainers who receive reports will respect the privacy and security of the
reporter and any affected people as much as practical. Maintainers may remove,
edit, or reject comments, commits, code, wiki edits, issues, and other
contributions that are not aligned with this Code of Conduct, and may ban
contributors temporarily or permanently for behavior they deem inappropriate,
threatening, offensive, or harmful.

## Enforcement Guidelines

Maintainers will follow these guidelines when determining the consequences for
